...
function getUEsWithInscriptions($pdo) {
    ...
    m.id AS idMaquette,
    o.idNiveauFormation,
    nf.code_niveau AS niveauFormation,
    sau.annee_academique AS annee,
...
JOIN filieres f on o.idFilieres = f.id
JOIN niveauformation nf on o.idNiveauFormation = nf.id
