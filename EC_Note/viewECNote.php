                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" id="menu">
                            ...
                            <div class="menu-item nav" id="menu">
                                ...
                                <div class="menu-link active" type="button" role="tab">
                                    ...
                                    <a class="menu-title" href="http://192.168.195.145/pedagogie/EC_Note/viewECNote.php">Saisie et consultation</a>
                                </div>
                                <div class="menu-link" type="button" role="tab">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                    ...
                                    <a class="menu-title" href="http://192.168.195.145/pedagogie/EC_Note/calculeMoyEc.php">Calcul Moyenne EC</a>
                                </div>
                                <div class="menu-link" type="button" role="tab">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                    ...
                                    <a class="menu-title" href="http://192.168.195.145/pedagogie/EC_Note/calculMoyUE.php">Calcul Moyenne UE</a>
                                </div>
                                <div class="menu-link" type="button" role="tab">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-2">
                                    ...
                                    <a class="menu-title" href="http://192.168.195.145/pedagogie/EC_Note/consolidationSemestrielle.php">Consolidation Semestrielle</a>
                                </div>
                                ...
                                <div class="mt-1 container-fluid card p-5">
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div id="filterContainer" class="mb-3 row g-3 align-items-center">
                                            <div class="col">
                                                <label for="filterAnnee" class="me-2 fw-bold">Année Académique</label>
                                                <select id="filterAnnee" class="form-select form-select-solid fw-bold w-auto">
                                                    <option value="">Toutes les années</option>
                                                    <option value="2025-2026">2025-2026</option>
                                                </select>
                                            </div>
                                            <div class="me-2 fw-bold col">
                                                <label for="filterSemestre" class="me-2 fw-bold">Période</label>
                                            ...
                                            <div class="me-2 fw-bold col">
                                                <label for="filterSession" class="me-2 fw-bold">Session</label>
                                                <select id="filterSession" class="form-select form-select-solid fw-bold w-auto">
                                            ...
                                            <div class="ms-4 col">
                                                <label for="filterFormation" class="me-2 fw-bold">Cycle</label>
                                            ...
                                            <div class="ms-4 col">
                                                <label for="niveau" class="me-2 fw-bold">Niveau</label>
                                                <select id="niveau" class="form-select form-select-solid fw-bold w-auto">
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function() {
                                                ...
                                                // Définition des relations Cycle -> Niveaux
                                                ...
                                                // Sauvegarde de l'option par défaut
                                                const defaultOption = '<option value="">Tous les niveaux</option>';

                                                cycleSelect.addEventListener('change', function() {
                                                    const cycleSelectionne = this.value;

                                                    // On réinitialise le sélecteur de niveau
                                                    niveauSelect.innerHTML = defaultOption;

                                                    if (cycleSelectionne && niveauxParCycle[cycleSelectionne]) {
                                                        // On ajoute dynamiquement les niveaux correspondants
                                                        niveauxParCycle[cycleSelectionne].forEach(niv => {
                                                            const option = document.createElement('option');
                                                            option.value = niv;
                                                            option.textContent = niv;
                                                            niveauSelect.appendChild(option);
                                                        });
                                                    } else if (!cycleSelectionne) {
                                                        // Si "Tous les cycles" est sélectionné, on peut afficher tous les niveaux
                                                        const tousLesNiveaux = [...niveauxParCycle["Licence"], ...niveauxParCycle["Master"], ...niveauxParCycle["Doctorat"]];
                                                        tousLesNiveaux.forEach(niv => {
                                                            const option = document.createElement('option');
                                                            option.value = niv;
                                                            option.textContent = niv;
                                                            niveauSelect.appendChild(option);
