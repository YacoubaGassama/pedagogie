                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        <div id="kt_content_container" class="container-xxl">
                            <div class="tab-pane w-100" id="nav-tachePost" role="tabpanel" aria-labelledby="nav-tachePost-tab">
                                ...
                                <div class="mt-1 container-fluid card p-5 bg-white">

                                    <div class="card-header">
                                        
                                        <form id="searchForm" method="post" action="">
                                            <h1 class="fs-2 fw-bolder">Recherche Etudiant par Matricule</h1>
                                            <input type="text" name="action" id="action" value="searchEtudiant" hidden />
                                            <div class="mb-3">
                                                <label for="matricule" class="form-label">Matricule</label>
                                                <input type="text" class="form-control" id="matriculeInput" name="matricule" required autocomplete="on" placeholder="Saisir matricule de l'étudiant"/>
                                            </div>
