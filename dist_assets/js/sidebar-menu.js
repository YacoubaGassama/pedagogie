...
// Vérification si l'élément actif existe
var activeLink = $('a.nav-link.menu-title.active');
var customScrollbar = $('.custom-scrollbar');

if (activeLink.length && customScrollbar.length) {
    // Animation pour faire défiler vers le lien actif
    customScrollbar.animate({
        scrollTop: customScrollbar.scrollTop() + activeLink.offset().top - customScrollbar.offset().top - 500
    }, 1000);
}
