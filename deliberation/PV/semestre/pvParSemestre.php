...
<html lang="fr">
<head>
    <title>UAHB - PV Délibération par Semestre</title>
    ...
    <link href="http://localhost/pedagogie/dist_assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" />
                ...
                <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper"
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div class="menu-link" type="button" role="tab">
                            ...
                            <a class="menu-title" href="http://localhost/pedagogie/deliberation/statistique/index.php">Statistique</a>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_header" class="header align-items-stretch">
                <div class="header-brand">
                    <a href="#"><img alt="Logo" src="http://localhost/pedagogie/dist_assets/media/logos/1.png" class="h-25px" /></a>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">PV Délibération par Semestre</h1>
                            <span class="h-20px border-gray-200 border-start mx-4"></span>
                            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                <li class="breadcrumb-item text-muted"><a href="#" class="text-muted text-hover-primary">Délibération</a></li>
                                <li class="breadcrumb-item"><span class="bullet bg-gray-200 w-5px h-2px"></span></li>
                                <li class="breadcrumb-item text-dark">PV par Semestre</li>
                            </ul>
                        </div>
                        <div class="d-flex gap-2" id="exportBtns" style="display:none!important;">
                            <button class="btn btn-sm btn-light-primary" onclick="pvParSemestre.imprimer()">
                                <i class="fas fa-print me-1"></i> Imprimer
                            </button>
                            <button class="btn btn-sm btn-light-success" onclick="pvParSemestre.exporterExcel()">
                                <i class="fas fa-file-excel me-1"></i> Excel
                            </button>
                            <button class="btn btn-sm btn-light-danger" onclick="pvParSemestre.exporterPDF()">
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <div class="row g-3 w-100">
                                    <div class="col-md-6 col-lg-2">
                                        <label class="form-label fw-semibold fs-7 text-muted text-uppercase"><i class="fas fa-graduation-cap me-1"></i> Filière</label>
                                        <select id="filterFiliere" class="form-select form-select-sm">
                                            <option value="">— Filière —</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-lg-2">
                                        <label class="form-label fw-semibold fs-7 text-muted text-uppercase"><i class="fas fa-layer-group me-1"></i> Cycle</label>
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <label class="form-label fw-semibold fs-7 text-muted text-uppercase"><i class="fas fa-sliders-h me-1"></i> Niveau</label>
                                        <select id="filterNiveau" class="form-select form-select-sm" disabled>
                                            <option value="">— Niveau —</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-lg-2">
                                        <label class="form-label fw-semibold fs-7 text-muted text-uppercase"><i class="fas fa-cogs me-1"></i> Option</label>
                                        <select id="filterOption" class="form-select form-select-sm" disabled>
                                            <option value="">— Option —</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-lg-2">
                                        <label class="form-label fw-semibold fs-7 text-muted text-uppercase"><i class="fas fa-calendar-alt me-1"></i> Semestre</label>
                        ...
                        <div class="mt-3" id="pvZone">
                            <div class="card">
                                <div class="card-body text-center py-10 text-muted" id="pvPlaceholder">
                                    ...
                                    <p class="fs-5">Sélectionnez un semestre pour afficher le procès verbal.</p>
                                </div>
                            </div>
                        </div>
...
<script src="pvParSemestre.js"></script>
</body>
</html>
