                            ...
                            <div class="tab-pane w-100" id="nav-tachePost" role="tabpanel" aria-labelledby="nav-tachePost-tab">
                                <div class="mt-1 container-fluid card p-5">
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div id="filterContainer" class="mb-3 d-flex flex-wrap align-items-center justify-content-start">
                                            <div class="m-1">

                                                <label for="filiterFiliere" class="me-2 fw-bold">Filière</label>
                                                <select id="filiterFiliere" class="form-select form-select-solid fw-bold w-250px">
                                                    <option value="">Sélectionner une filière</option>
                                                </select>
                                            </div>
                                            <div class="m-1">
                                                <label for="filterOption" class="ms-4 me-2 fw-bold">Options</label>
                                                <select id="filterOption" class="form-select form-select-solid fw-bold w-250px">
                                                    <option value="">Sélectionner une option</option>
                                                </select>
                                            </div>
                                            <div class="m-1">
                                                <label for="filterCycle" class="ms-4 me-2 fw-bold">Cycle</label>
                                                <select id="filterCycle" class="form-select form-select-solid fw-bold w-250px">
                                            ...
                                            <div class="m-1">
                                                <label for="filterNiveau" class="ms-4 me-2 fw-bold">Niveau</label>
                                                <select id="filterNiveau" class="form-select form-select-solid fw-bold w-250px">
                                                    <option value="">Sélectionner un Niveau</option>
                                                </select>
                                            </div>
                                            <div class="m-1">
                                                <label for="filterSemester" class="ms-4 me-2 fw-bold">Semestre</label>
                                                <select id="filterSemester" class="form-select form-select-solid fw-bold w-250px">
                                            ...
                                            <div id="ecContainer" class="card bg-white col-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="ecTable">
                                                            <thead>
                                                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                            ...
                                                            <tbody class="fw-bold text-gray-600" id="ecTableBody">
                                                                <!-- Les données des EC seront insérées ici dynamiquement -->
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
